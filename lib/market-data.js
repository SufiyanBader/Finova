...
/**
 * Fetch stock price.
 * For US stocks, uses Twelve Data.
 * For Indian stocks (.NS / .BO), uses Yahoo Finance (Twelve Data free tier doesn't support Indian markets).
 * Returns null on failure.
 */
async function fetchStockPrice(symbol) {
  // ── Indian Stocks (Yahoo Finance Free API) ─────────────────────────────────
