...
export async function sendChatMessage(message, conversationHistory) {
  try {
    ...
    const systemPrompt = `
      You are Finova assistant, a helpful personal finance assistant.
    ...
    const history = [
      { role: "user", parts: [{ text: systemPrompt }] },
      {
        ...
        parts: [
          {
            text: "I have received your financial data and guidelines. I am ready to assist you as Finova assistant. How can I help you today?",
          },
        ],
      },
